...
TEST_F(SymmetricMatrixTestMixed, parseSymmetricMatrixMixedBS4) {
  ...
  SymmetricMatrixMixed matrix =
      MatrixParserMixed::parseSymmetricMatrix(path, queue);
...
TEST(MatrixParserMixedTest, parseRowString) {
  ...
  std::vector<double> result = {
      3.28800491977049302861e-02,  -8.18219670384158145882e-03,
      9.21129397428693656464e-05,  7.22668449547045899095e-02,
      -1.75117094933355359199e-02, 2.43594298214563180494e-02,
      -3.42271744814721390338e-02, 5.27051749627409447246e-03,
      -7.53461080610220157450e-02, 7.11621899095706972327e-02,
      -5.05960381205778075842e-02, 3.11925272356795950379e-02,
...
TEST(MatrixParserMixedTest, parseRowStringInvalid) {
  EXPECT_THROW(MatrixParserMixed::getRowValuesFromString("abc"),
