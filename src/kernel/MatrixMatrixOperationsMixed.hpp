...
class MatrixMatrixOperationsMixed {
  public:
     ...
     * @return a sycl event of the kernel execution
     */
    static sycl::event triangularSolve_optimizedCPU(sycl::queue &queue, void *A,
                                                    int *precisionTypes,
                                                    std::size_t *blockByteOffsets, int blockID,
                                                    int blockRow, int blockStart, int blockCount);
     ...
     * @return a sycl event of the kernel execution
     */
    static sycl::event symmetricMatrixMatrixDiagonal(sycl::queue &queue, void *A,
                                                     int *precisionTypes,
                                                     std::size_t *blockByteOffsets, int blockID,
                                                     int blockRow, int blockStart, int blockCount,
                                                     int blockCountXY);
    ...
    static sycl::event symmetricMatrixMatrixDiagonal_optimizedGPU(
        ...
        int blockID, int blockRow, int blockStart, int blockCount, int blockCountXY);
     ...
     * @return a sycl event of the kernel execution
     */
    static sycl::event matrixMatrixStep_optimizedGPU(sycl::queue &queue, void *A,
                                                     int *precisionTypes,
                                                     std::size_t *blockByteOffsets, int blockID,
                                                     int blockRow, int blockStart, int blockCount,
                                                     int blockCountXY);
     ...
     * @return a sycl event of the kernel execution
     */
    static sycl::event matrixMatrixStep_optimizedCPU(sycl::queue &queue, void *A,
                                                     int *precisionTypes,
                                                     std::size_t *blockByteOffsets, int blockID,
                                                     int blockRow, int blockStart, int blockCount,
                                                     int blockCountXY);
