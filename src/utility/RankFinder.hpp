...
class RankFinder {
  public:
    ...
    static std::vector<int> compute_block_precisions(
        ...
        double verticalLengthscale = 1.0, double lengthscale = 1.0, double noiseVariance = 0.01);
  ...
  private:
    ...
    static int compute_rank_qr(std::vector<double> &A, int m, int n, double tol = 3e-2);
    ...
    static int compute_block_rank(
        ...
        std::size_t nRegressors, double verticalLengthscale = 1.0, double lengthscale = 1.0,
