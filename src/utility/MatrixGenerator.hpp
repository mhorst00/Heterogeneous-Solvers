...
public:
  /**
   * This operation generates a diagonal dominant SPD matrix. (Currently not
   * used)
   *
  ...
  generateSPDMatrixStrictDiagonalDominant(sycl::queue &queue);

  /**
   * This operation generates a SPD kernel matrix that can be used for Gaussian
   * Processes
   *
   ...
   */
  static void generateTestKernelMatrix(std::string &path_train,
  ...
  /**
   * This operation parses the right hand side based on data for Gaussian
   * processses
   *
